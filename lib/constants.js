...
if (!API_TOKEN && !API_KEY) {
  console.error(
    ...
    "Create an API token with Zero Trust Gateway Lists and Rules permissions and add it to your environment or .env file."
  );
  process.exit(1);
}
if (!ACCOUNT_ID) {
  console.error(
    ...
    "Find your Account ID on the Cloudflare dashboard and add it to your environment or .env file."
  );
  process.exit(1);
}
